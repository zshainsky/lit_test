(function () {
    ...
    `;
        ...
        render () {
            ...
            ${this.rooms.map( 
                (item, index) => p `
                    <div id="${index}" class=${o(this.eventGridRoom)} @click="${this.handleClick}" @mouseover="${this.handleMouseOver}" @mouseleave="${this.handleMouseLeave}"  >
                        ${item}
                    </div>`
            )}
            </div>
        ...
        handleClick(e){
            ...
            if (gridItems.length > 0) {
                ...
                for (let item of gridItems) {
                    // if the current item is the same as the value in the array
        ...
        handleMouseOver(e) {
            ...
            e.currentTarget.parentElement.classList.toggle("mouseover");
